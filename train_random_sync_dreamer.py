...
if __name__ == "__main__":
    ...
    default_callbacks_cfg = {
        "setup_callback": {
            "target": "train_random_sync_dreamer.SetupCallback",
            "params": {"resume": opt.resume, "logdir": logdir, "ckptdir": ckptdir, "cfgdir": cfgdir, "config": config}
        },
        "learning_rate_logger": {
            "target": "train_random_sync_dreamer.LearningRateMonitor",
            "params": {"logging_interval": "step"}
        },
        "cuda_callback": {"target": "train_random_sync_dreamer.CUDACallback"},
    }
    ...
    ####################lr#####################
    bs, base_lr = config.data.train_batch_size, config.model.base_learning_rate
